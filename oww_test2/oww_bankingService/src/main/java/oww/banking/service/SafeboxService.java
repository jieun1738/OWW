...
public class SafeboxService {
    ...
    public boolean setSafeboxAmount(String userEmail, BigDecimal amount) {
        try {
            ...
            BigDecimal accountBalance = BigDecimal.valueOf(account.getBalance()); // int를 BigDecimal로 변환
    ...
    public BigDecimal getTotalAssets(String userEmail) {
        ...
        if (account != null) {
            accountBalance = BigDecimal.valueOf(account.getBalance()); // int를 BigDecimal로 변환
        }
    ...
    public List<SafeboxHistoryVO> getHistoryByUserEmail(String userEmail) {
        return safeboxMapper.findHistoryByUserEmail(userEmail);
    }
