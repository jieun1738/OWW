...
public class JwtUtil {
    ...
    // ===============================
    // 토큰 생성 (Gateway와 완전히 호환)
    // ===============================
    public String generateToken(Long userNo, String username, String userEmail) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("userNo", userNo);
        claims.put("username", username);
        claims.put("userEmail", userEmail);  // userEmail로 통일
    ...
    // ===============================
    // 디버깅용 메서드 (OAuth2SuccessHandler에서 필요)
    // ===============================
