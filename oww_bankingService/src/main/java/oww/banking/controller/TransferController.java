...
public class TransferController {
   ...
   public String processTransfer(
      ...
      System.out.println("=== 컨트롤러 메소드 시작 ===");
      ...
      try {
          ...
          System.out.println("=== 이체 처리 시작 ===");
          // 콤마 제거 후 BigDecimal로 변환
          ...
          // 이체 성공 시 (null이거나 오류 메시지가 아니면 성공으로 판단)
          if (result == null || (!result.contains("오류") && !result.contains("실패") && !result.contains("부족"))) {
              System.out.println("=== 성공 조건 통과, transfer_3로 이동 ===");
              
              // 받는 분 이름 설정
              String finalRecipientName = recipientName;
              if (finalRecipientName == null || finalRecipientName.trim().isEmpty()) {
                  finalRecipientName = "알 수 없음";
              }
              ...
              System.out.println("=== 실패 조건, transfer_2로 이동 ===");
